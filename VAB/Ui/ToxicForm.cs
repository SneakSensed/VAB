...
namespace VAB.Ui
{
    public partial class ToxicForm : ToxicFormBase
    {
        const string DEFTITLE = "";
        ...
        public ToxicForm(TemplateUnitBase tu, IReactable binded)
            : base(tu)
        {
            InitializeComponent();

            #region visual
            this.Text = (DEFTEXT != "") ? DEFTEXT : Statics.ERname(tu.TemplateFileName);
            //title
